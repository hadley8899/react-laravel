...
import CustomerTagSelect from '../components/customer/CustomerTagSelect';
...
const EmailTemplateSend: React.FC = () => {
    ...
    useEffect(() => {
        ...
        getCustomerCountByTags(selectedTags.map(t => t.uuid))
    ...
    const handleSend = useCallback(async () => {
        ...
        try {
            const {uuid: campaignUuid} = await sendCampaign({
                ...
                tag_uuids: selectedTags.map((t) => t.uuid),
    ...
    return (
        <MainLayout title="Send Email Campaign">
